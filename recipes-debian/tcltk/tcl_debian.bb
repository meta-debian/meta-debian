# base recipe: meta/recipes-devtools/tcltk/tcl_8.6.9.bb
# base branch: warrior
...
do_install() {
	...
	ln -sf ./tclsh${PV} ${D}${bindir}/tclsh
	ln -sf tclsh8.6 ${D}${bindir}/tclsh${PV}
	...
	for dir in compat generic unix; do
		install -d ${D}${includedir}/${BPN}${PV}/$dir
		install -m 0644 ${S}/../$dir/*.h ${D}${includedir}/${BPN}${PV}/$dir/
	done
}
...
FILES_${PN} += "${libdir}/tcl${PV} ${libdir}/tcl${VER} ${libdir}/tcl8"
