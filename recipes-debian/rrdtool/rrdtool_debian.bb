...
EXTRA_OECONF += "\
	...
	--with-tcllib=${STAGING_LIBDIR}/${DEB_HOST_MULTIARCH}/tcl8.6 \
...
do_install_append() {
	...
	install -d ${D}${nonarch_libdir}/tcltk/rrdtool-tcl

	mv ${D}${libdir}/tclrrd1.*.so ${D}${nonarch_libdir}/tcltk/rrdtool-tcl/
	
	install -m 0644 ${S}/bindings/tcl/pkgIndex.tcl \
		${D}${nonarch_libdir}/tcltk/rrdtool-tcl/
...
FILES_${PN}-tcl = "${nonarch_libdir}/tcltk/*"
FILES_${PN}-dbg += "\
	${libdir}/${PYTHON_DIR}/site-packages/.debug \
	${libdir}/perl5/*/auto/RRDs/.debug ${nonarch_libdir}/tcltk/rrdtool-tcl/.debug \
	${libdir}/lua/*/.debug"
