...
FILESPATH_append = ":${BASE_RECIPE_DIR}/python"

DISTRO_SRC_URI ?= "file://sitecustomize.py"
DISTRO_SRC_URI_linuxstdbase = ""

# inherit patch files from meta
# remove meta CVE patch bpo-35907-cve-2019-9948.patch, bpo-36216-cve-2019-9636.patch,
# bpo-35907-cve-2019-9948-fix.patch, bpo-36216-cve-2019-9636-fix.patch, CVE-2019-9740.patch.
# all patch that start with "revised" is modified patch to avoid conflict with debian source
SRC_URI += "file://revised-01-use-proper-tools-for-cross-build.patch \
...
python(){
    ...
    filename = os.path.join(d.getVar('BASE_RECIPE_DIR'), 'python', 'python2-manifest.json')
