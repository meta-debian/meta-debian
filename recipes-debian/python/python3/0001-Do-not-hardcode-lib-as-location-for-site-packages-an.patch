# base patch: meta/recipes-devtools/python/python3/0001-Do-not-hardcode-lib-as-location-for-site-packages-an.patch
# base branch: warrior
#
...
--- a/Lib/site.py
+++ b/Lib/site.py
@@ -341,22 +341,22 @@ def getsitepackages(prefixes=None):
