# base-classes: http://cgit.openembedded.org/meta-openembedded/tree/meta-networking/classes/waf-samba.bbclass
# base-branch: morty
...
do_configure() {
    ...
    cat ${COREBASE}/meta-debian/files/waf-cross-answers/cross-answers-${TARGET_ARCH}.txt >> ${CROSS_ANSWERS}
