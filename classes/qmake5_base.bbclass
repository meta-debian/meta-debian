#
# base class: meta-qt5/classes/qmake5_base.bbclass
# base commit: c9a1041cb956d94c04cbf635b00ca19725ffc129
#

# This is useful for target recipes to reference native mkspecs
QMAKE_MKSPEC_PATH_NATIVE = "${STAGING_LIBDIR_NATIVE}/${DEB_BUILD_MULTIARCH}/${QT_DIR_NAME}"
QMAKE_MKSPEC_PATH_TARGET = "${STAGING_DIR_HOST}${nonarch_libdir}/${DEB_HOST_MULTIARCH}/${QT_DIR_NAME}"
...
OE_QMAKE_QMAKE = "${STAGING_LIBDIR_NATIVE}/${DEB_BUILD_MULTIARCH}/${QT_DIR_NAME}/bin/qmake"
