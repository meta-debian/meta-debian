...
OE_QMAKE_PATH_HOST_BINS ?= "${libdir}/${QT_DIR_NAME}/bin"
OE_QMAKE_PATH_HOST_DATA ?= "${QMAKE_MKSPEC_PATH_TARGET}"
OE_QMAKE_PATH_HOST_LIBS ?= "${STAGING_LIBDIR}"
OE_QMAKE_PATH_EXTERNAL_HOST_BINS ?= "${STAGING_LIBDIR_NATIVE}/${QT_DIR_NAME}/bin"
...
OE_QMAKE_PATH_QT_BINS ?= "${libdir}/${QT_DIR_NAME}/bin"
...
OE_QMAKE_PATH_QT_EXAMPLES ?= "${libdir}/${QT_DIR_NAME}/examples"
